...
//         'userId': user?.uid ?? '',
//         'productId': prodList[i].id,
//         'productTitle': prodList[i].title,
//         'productPrice': prodList[i].price.toString(),
//         'productDescription': prodList[i].description,
//         'productCategory': 'Test',
//         'productImage': prodList[i].imageUrl,
